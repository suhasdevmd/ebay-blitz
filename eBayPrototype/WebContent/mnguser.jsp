																		...
																		<div>
																			...
																			<form action="ManageUserPostAction" method="post">
																				...
																				<table align="center" id="outer"
																					style="border: 2px solid black; border-width: 1px;">

																					<tr id="outer">
																						<th align="center"><h3>Seller Name</h3>
																						</th>
																						<th align="center"><h3>Average Rating</h3>
																						</th>
																						<th align="center"><h3>Block/Unblock</h3>
																						</th>
																					</tr>
																					<s:iterator value="sellerList">
																						<tr id="outer">
																							...
																							<td id="outer"><s:checkbox label=" "
																									...
																									value="selectedDefault" theme="simple" />
																							</td>
																			...
																			<div align="right" style="margin-top: 40px;">
																				<input type="submit" name="UpdateBlockList"
																					value="UpdateBlockList" id="mysubmit" align="right" />
																			</div>
