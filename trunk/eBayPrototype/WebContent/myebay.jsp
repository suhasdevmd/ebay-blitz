												...
												<table border="0" width="100%" cellpadding="0"
													...
													<tr>
														<td width="100%" class="A4" rowspan="2"><img
															...
															href="homepage.action"><b
																class="g-hdn">Member id</b><span class="A4B"><s:property value="%{#session.userdetails.firstName}" /></span>
															...
															href="http://feedback.ebay.in/ws/eBayISAPI.dll?ViewFeedback&amp;userid=suhasdevmd&amp;ssPageName=STRK:ME:UFS"><b
																class="g-hdn">Feedback Score Of </b>0</a>) --><br></td>
															...
															<td>
																<table cellspacing="0" cellpadding="3" width="100%"
																	...
																	<tr>
																		...
																		<td><img
																			src="http://pics.ebaystatic.com/aw/pics/s.gif"
																			width="16" height="2" alt=""></td>
																		<td width="100%"><img
																			src="http://pics.ebaystatic.com/aw/pics/s.gif"
																			width="400" height="2" alt=""></td>
																	</tr>
																	<tr valign="top">
																		<td><img
																			src="http://pics.ebaystatic.com/aw/pics/s.gif"
																		...
																		<div>
																			<form action="wishlist.action" method="post" name="myForm">
		<table id="myTable">
