...
<body bgcolor="#ffffff">
								...
								<tr>
									<%-- <td valign="middle" class="bc"><a
										...
										href="http://my.ebay.in/ws/eBayISAPI.dll?MyeBay&amp;ssPageName=STRK:ME:BRED">My
											eBay</a> &gt; <strong>My Account</strong></td> --%>
								</tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								bgcolor="#7D81D7">
								<tr>
									<td>
										<div id="areaTitle"
											...
											<h1 style="white-space: nowrap; color: #F1F1F1">My Ebay</h1>
											<div
										...
										<td class="nb" width="100%" colspan="3">
											<dl id="c">
												<dt class="notgreylabel">
													<a href="myEbay.action" id="my_MyeBaySummary">Wishlist</a>
												</dt>
											</dl>
											<div class="sep"></div>
											<dl id="c">
							...
							<div class="centerClass" id="ContainerWrapper">
								<div id="Container">
												...
												<table border="0" width="100%" cellpadding="0"
													...
													<tr>
														<td width="100%" class="A4" rowspan="2"><img
															...
															href="homepage.action"><b class="g-hdn">Member id</b><span
																class="A4B"><s:property
																		value="%{#session.userdetails.firstName}" />
															</span> </a>
														<!-- <img src="http://pics.ebaystatic.com/aw/pics/s.gif"
															...
															href="http://feedback.ebay.in/ws/eBayISAPI.dll?ViewFeedback&amp;userid=suhasdevmd&amp;ssPageName=STRK:ME:UFS"><b
																class="g-hdn">Feedback Score Of </b>0</a>) -->
															<br>
														</td>
									...
									<table border="0" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td><img src="http://pics.ebaystatic.com/aw/pics/s.gif"
												height="10" width="1" alt="">
											</td>
										</tr>
									</table>
									<span id=""><table bgcolor="#ffcc00" border="0"
																				...
																				<table id="myTable">
																					<s:iterator value="orderDetails">
																						...
																						<tr>
																							...
																							<td><s:property value="totalAmt" />
																							</td>
																							<td><s:property value="shippingStatus" />
																							</td>
																							<td><a
																								href="view-order-status.action?orderID=<s:property value = "orderID" />">Check
																									Status</a>
																						</tr>
									...
									<img src="http://pics.ebaystatic.com/aw/pics/s.gif" height="15"
										width="1" alt=""><a name="" id="Anchor"></a>
	...
	<div id="option_layer" name="option_layer"
