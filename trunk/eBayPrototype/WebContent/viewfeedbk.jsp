															...
															<td width="100%">
																<table border="0" cellpadding="3" cellspacing="0"
																	...
																	<tr bgcolor="#ffffcc" valign="center" height="25"
																		...
																		<td width="100%" class="A2B">View all the feedbacks</td>
																	</tr>
																</table></td>
														</tr>
																	...
																	<tr valign="top">
																		...
																		<div>
																			...
																			<form action="ManageUserPostAction" method="post">
																				...
																				<table
																					style="border: 2px solid black; border-width: 1px;margin-bottom: 30px;" align="center">

																					<tr>
																						<th align="center"><h3>From</h3>
																						</th>
																						<th align="center"><h3>Feedback</h3>
																						</th>
																						<th align="center"><h3>Date</h3>
																						</th>
																						<th align="center"><h3>To</h3>
																						</th>
																						<th align="center"><h3>Rating</h3>
																						</th>
																					...
																					<s:iterator value="feedbacks">
																						<tr>
																							...
																							<td><s:property value="sellername" />
																							</td>
																							<td><s:property value="rating" />
																							</td>
