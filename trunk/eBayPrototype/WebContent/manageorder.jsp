			...
			<div class="pagewidth">
				<div class="pageminwidth">
						...
						<%-- <div id="bodyContent">
							...
							<div class="centerClass" id="ContainerWrapper">
								<div id="Container">
									...
									<span id=""> <!--     manage order code starts ----------------------------- -->
										...
										<div>
											...
											<s:form>
												...
												<table
													...
													<tr>
														<th align="center"><h3>Order ID</h3>
														</th>
														<th align="center"><h3>Buyer</h3>
														</th>
														<th align="center"><h3>Product</h3>
														</th>
														<th align="center"><h3>Total Amount</h3>
														</th>
														<th align="center"><h3>Quantity</h3>
														</th>
														<th align="center"><h3>Status</h3>
														</th>
														<th align="center"><h3>Update Status</h3>
														</th>
													</tr>
													...
													<s:iterator value="orderList">
														<tr>
															...
															<s:hidden value="orderID"></s:hidden>
					...
					<s:property value="details" /> </a></td> --%>
															...
															<td align="center"><s:property value="productName" />
															</td>
															<td align="center"><s:property value="amount" />
															</td>

															<td align="center"><s:property value="quantity" />
															</td>
															...
															<td><a
																href="updateorder.action?orderID=<s:property value = "orderID" /> & username=<s:property value = "username" /> &productName=<s:property value = "productName" />">
																	Update</a>
															</td>
										...
										</div> <%-- <hr /> <!-- Add category detail --> <s:form
